...
import { Routes, Route, useParams, useRouteMatch, useLocation } from 'react-router-dom';
...
export default () => {
  ...
  return(
    <div className='wraperitem'>
      <section className='jumbotron breadcumb bigBanner' style={{backgroundImage: `url(${'./img/big-banner-malalcura.jpg'})`}}>
